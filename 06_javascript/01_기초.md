...
- `callback 함수`
  ...
  const result = numbers.reduce((acc, num) =>{
      return acc  + num }, 0)  //0은 initial value
...
- 메서드 내부에서는 this 키워드가 객체를 의미함
  ...
  - 구조분해할당
    ...
    - ![image-20220426111845269](images/image-20220426111845269.png).
...
- function keyword와 화살표 함수의 차이
  ...
  const obj = {
      ...
      radiuses: [1, 2, 3, 4, 5],
      printArea:function(){
      	this.radiuses.forEach(function(r){ console.log(this.PI*r*r)
                                           }.bind(this))
      }
